...
#excel file for the year list and the inflation rate
inflation_url = "https://filetransfer.io/data-package/K5QHuhko/download"
...
df = df.drop(columns = ["Unemployment", "Inflation", "Interest", "GDP"])
